...
class OtodomSpider(scrapy.Spider):
    ...
    def start_requests(self):
        start_urls = [
            self.base_url + '/nieruchomosci/mieszkania/jelenia-gora?promien=25&data-dodania-search=ostatniego-miesiaca',
            self.base_url + '/nieruchomosci/domy/jelenia-gora?data-dodania-search=ostatniego-miesiaca&promien=25',
            self.base_url + '/nieruchomosci/dzialki-grunty/jelenia-gora?promien=25'
            ]
    ...
    def parse(self, response):
        ...
        offer_links = response.xpath('//h2[@class="teaserUnified__anchor"]/a/@href').getall()
        ...
        next_page = response.xpath('//ul/li[@class="pagination_nextPage"]/a/@href').get()
        if next_page:
